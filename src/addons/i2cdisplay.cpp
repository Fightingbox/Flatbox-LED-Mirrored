...
void I2CDisplayAddon::drawSticklessMirrored(int startX, int startY, int buttonRadius, int buttonPadding)
{
	...
	// 8-button
	obdPreciseEllipse(&obd, startX , startY, buttonRadius, buttonRadius, 1, pGamepad->pressedB3());
	obdPreciseEllipse(&obd, startX + buttonMargin , startY - (buttonMargin / 4), buttonRadius, buttonRadius, 1, pGamepad->pressedB4());
	obdPreciseEllipse(&obd, startX + (buttonMargin * 2), startY - (buttonMargin / 4), buttonRadius, buttonRadius, 1, pGamepad->pressedR1());
	obdPreciseEllipse(&obd, startX + (buttonMargin * 3), startY, buttonRadius, buttonRadius, 1, pGamepad->pressedL1());

	obdPreciseEllipse(&obd, startX , startY + buttonMargin, buttonRadius, buttonRadius, 1, pGamepad->pressedB1());
	obdPreciseEllipse(&obd, startX + buttonMargin , startY + buttonMargin - (buttonMargin / 4), buttonRadius, buttonRadius, 1, pGamepad->pressedB2());
	obdPreciseEllipse(&obd, startX + (buttonMargin * 2), startY + buttonMargin - (buttonMargin / 4), buttonRadius, buttonRadius, 1, pGamepad->pressedR2());
	obdPreciseEllipse(&obd, startX + (buttonMargin * 3), startY + buttonMargin, buttonRadius, buttonRadius, 1, pGamepad->pressedL2());
...
void I2CDisplayAddon::drawSticklessButtonsMirrored(int startX, int startY, int buttonRadius, int buttonPadding)  
{
	...
	obdPreciseEllipse(&obd, startX + (buttonMargin * 6),startY, buttonRadius, buttonRadius, 1, pressedLeft());
	obdPreciseEllipse(&obd, startX + (buttonMargin * 5), startY, buttonRadius, buttonRadius, 1, pressedDown());
	obdPreciseEllipse(&obd, startX + (buttonMargin * 4.125), startY + (buttonMargin / 2), buttonRadius, buttonRadius, 1, pressedRight());
